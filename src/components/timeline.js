...
export default function Timeline() {
    ...
    const timeline = [
        ...
        // getting started screen
        // (c) => <Instruction id="blockBeginningText" ind="1" next={next} prev={prev} curr={c.i} />,

        // content
        // (c) => <Block next={next} curr={c} props={props[1]} />,
        // (c) => <Instruction id="betweenBlocksText" ind="0" next={next} prev={prev} curr={c.i} />,
        ...
        // getting started screen
        // (c) => <Instruction id="blockBeginningText" ind="2" next={next} prev={prev} curr={c.i} />,
        ...
        // ending
        (c) => <Instruction id="endingText" ind="0" prev={prev} curr={c.i} />,
    ]
